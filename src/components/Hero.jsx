      ...
      >
        ...
        >
          ...
          <p className={`${styles.paragraph} max-w-[470] mt-5`}>
            Experience the power of our two cutting-edge models, Model A for
            face recognition and Model B for emotions prediction, designed to
            deliver unparalleled performance and versatility for all your needs.
          </p>
        </div>
        <div
        ...
        >
          {!realTime && (
            <img
              src={robot}
              alt="billing"
              className="w-[100%] h-[100%] relative z-[5] blend-bg-gray-500 rounded-md"
            />
          )}
          {realTime && (
            <div>
